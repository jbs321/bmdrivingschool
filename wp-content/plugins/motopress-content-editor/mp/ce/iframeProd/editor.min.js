...
this.formsMainCtrl.renderShortcode();if("mp_row"===this.shortcodeName||"mp_row_inner"===this.shortcodeName)switch(a.name){case "bg_media_type":this.setRowMediaBG(e);break;case "bg_video_youtube":case "bg_video_youtube_cover":this.clearRowMediaBG(this.shortcode);this.renderYoutubeBG();break;case "bg_video_webm":case "bg_video_mp4":case "bg_video_ogg":case "bg_video_cover":this.clearRowMediaBG(this.shortcode);this.renderHTML5VideoBG();break;case "stretch":(a=this.getStretchClassByValue(e))?this.setRowWidth(a):
this.clearRowWidth();parent.MP.Editor.triggerIfr("Resize");break;case "width_content":a=this.getContentWidthClassByValue(e);this.setRowWidth(a);parent.MP.Editor.triggerIfr("Resize");break;case "full_height":"true"===e?this.shortcode.addClass("mp-row-fullheight"):this.shortcode.removeClass("mp-row-fullheight"),parent.MP.Editor.triggerIfr("Resize")}}}},getStretchClassByValue:function(a){var b="";switch(a){case "full":a=this.getCtrlByName("width_content").get();b=this.getContentWidthClassByValue(a);
break;case "fixed":b="mp-row-fixed-width"}return b},getContentWidthClassByValue:function(a){var b="";switch(a){default:b="mp-row-fullwidth";break;case "full":b="mp-row-fullwidth-content";break;case "fixed":b="mp-row-fixed-width-content"}return b},display:function(a,b,d){"undefined"===typeof b&&(CE.Dialog.myThis.settingsTab.children(".motopress-settings-forms").detach(),CE.Dialog.myThis.settingsTab.html(this.form));var e=this.getAttrs();if(e){var f=this,g=null,l=null,h=this.getGeneralAttrs();if("undefined"!==
typeof b){var m={};m[b]=h[b];h=m}var k=null,q=null;c.each(h,function(b,m){g=f.getParameterElByName(b);g.hasClass("motopress-property-group")&&(d&&g.trigger("change",a),g.find(".motopress-property-group-accordion-item").each(function(){c(this).control().display(a)}),g.trigger("render",a));q=g.control();m.hasOwnProperty("saveInContent")&&"true"===m.saveInContent?"undefined"!==typeof f.shortcode.attr("data-motopress-content")&&(l=f.shortcode.attr("data-motopress-content").replace(/\[\]/g,"[")):l=e[q.name].value;
k=h[q.name]["default"];q.set(l,k,a);g.trigger("customize")});this.resolveDependencies()}},renderYoutubeBG:function(){var a=this,b="undefined"!==typeof this.shortcode.attr("data-motopress-parameters")?this.shortcode.attr("data-motopress-parameters"):null,b=c.parseJSON(b);c.ajax({url:parent.motopress.ajaxUrl,type:"POST",dataType:"text",data:{action:"motopress_ce_render_youtube_bg",nonce:parent.motopressCE.nonces.motopress_ce_render_youtube_bg,postID:parent.motopressCE.postID,bg_video_youtube:b.bg_video_youtube.value,
bg_video_youtube_cover:b.bg_video_youtube_cover.value,bg_video_youtube_repeat:b.bg_video_youtube_repeat.value,bg_video_youtube_mute:b.bg_video_youtube_mute.value},success:function(b){a.shortcode.addClass("mp-row-video").children(".motopress-row-helper").before(b);mpInitYouTubePlayers(a.shortcode.children(".mp-video-container").find(".mp-youtube-video"));mpFixBackgroundVideoSize(a.shortcode.children(".mp-video-container"))},error:function(a){console.log(a)}})},renderHTML5VideoBG:function(){var a=this,
b="undefined"!==typeof this.shortcode.attr("data-motopress-parameters")?this.shortcode.attr("data-motopress-parameters"):null,b=c.parseJSON(b);c.ajax({url:parent.motopress.ajaxUrl,type:"POST",dataType:"text",data:{action:"motopress_ce_render_video_bg",nonce:parent.motopressCE.nonces.motopress_ce_render_video_bg,postID:parent.motopressCE.postID,bg_video_mp4:b.bg_video_mp4.value,bg_video_webm:b.bg_video_webm.value,bg_video_ogg:b.bg_video_ogg.value,bg_video_cover:b.bg_video_cover.value,bg_video_mute:b.bg_video_mute.value,
bg_video_repeat:b.bg_video_repeat.value},success:function(b){a.shortcode.addClass("mp-row-video").children(".motopress-row-helper").before(b);mpFixBackgroundVideoSize(a.shortcode.children(".mp-video-container"))},error:function(a){console.log(a)}})},setRowWidth:function(a){this.clearRowWidth();this.shortcode.addClass(a)},clearRowWidth:function(){this.shortcode.removeClass("mp-row-fullwidth mp-row-fullwidth-content mp-row-fixed-width mp-row-fixed-width-content");this.shortcode.css({width:"","padding-left":"",
"margin-left":"","padding-right":"","margin-right":""})},setRowMediaBG:function(a){this.clearRowMediaBG(this.shortcode);switch(a){case "video":this.renderHTML5VideoBG();break;case "youtube":this.renderYoutubeBG();break;case "parallax":a=this.form.find('[data-motopress-parameter="parallax_image"] [data-full-src]').length?this.form.find('[data-motopress-parameter="parallax_image"] [data-full-src]').attr("data-full-src"):null,this.shortcode.addClass("motopress-row-parallax").attr("data-stellar-background-ratio",
.5),a&&this.shortcode.css("background-image","url('"+a+"')"),c.stellar("refresh")}},clearRowMediaBG:function(a){a.children(".mp-video-container").remove();a.removeClass("mp-row-video motopress-row-parallax").css("background-image","").css("background-position","");a.removeAttr("data-stellar-background-ratio").removeData("stellarBackgroundIsActive stellarBackgroundRatio stellarBackgroundStartingLeft stellarBackgroundStartingTop");c.stellar("refresh")}})}(jQuery),function(c){CE.SettingsControlsForm("CE.SettingsControlsChildForm",
{},{init:function(a,b){this._super(a,b);this.parentFormCtrl=b.parentFormCtrl;this.groupCtrl=b.groupCtrl},changeProperty:function(a){this.save(a);this.groupCtrl.element.trigger("change")},setDefaultAttrs:function(a){if(null!==a){a=c.parseJSON(a);var b=this.getGeneralAttrs(),d=this;c.each(a,function(a,c){"undefined"!==typeof c.value&&c.value||("mp_tab"===d.shortcodeName&&"id"===a?c.value=parent.MP.Utils.uniqid():b[a].hasOwnProperty("saveInContent")&&"true"===b[a].saveInContent?d.shortcode.attr("data-motopress-content",
b[a]["default"]):c.value=b[a]["default"])});this.setAttrs(a);return JSON.stringify(a)}return a},detectForm:function(){this.form=this.element.children(".motopress-property-group-accordion-item-content")},save:function(a){if("undefined"!==typeof a&&"undefined"!==typeof a.name){var b=this.getAttrs();if(b){var c=this.getGeneralAttrs()[a.name],e=a.get();c.hasOwnProperty("saveInContent")&&"true"===c.saveInContent?this.shortcode.attr("data-motopress-content",e):b[a.name].value=void 0!==e&&"string"===typeof e?
e.replace(new RegExp(/"/g),"'").replace(new RegExp(/[\[\]]/g),""):e;this.setAttrs(b)}}},display:function(a,b){var d=this.getAttrs();if(d){var e=this,f=null,g=this.getGeneralAttrs();if("undefined"!==typeof b){var l={};l[b]=g[b];g=l}var h=null,m=null;c.each(g,function(b,c){m=e.getCtrlByName(b);c.hasOwnProperty("saveInContent")&&"true"===c.saveInContent?"undefined"!==typeof e.shortcode.attr("data-motopress-content")&&(f=e.shortcode.attr("data-motopress-content").replace(/\[\]/g,"[")):f=d[m.name].value;
"id"===b&&"mp_accordion_item"===e.shortcodeName&&"undefined"===typeof f&&(f=e.shortcode.find(".motopress-accordion-item").attr("id"));h=g[m.name]["default"];m.set(f,h,a)});this.resolveDependencies()}}})}(jQuery),function(c){CE.ControlsForm("CE.StyleControlsForm",{},{init:function(a,b){this._super(a,b)},changeProperty:function(a){this.save(a);c("body").trigger("MPCEObjectStyleChanged",{objElement:this.shortcode,objName:this.shortcodeName})},getGeneralAttrs:function(){return CE.LeftBar.myThis.getStyleAttrs(this.shortcodeGroup,
this.shortcodeName)},getAttrs:function(){var a=this.shortcode.attr("data-motopress-styles");return a?(a=c.parseJSON(a),!this.formsMainCtrl.isGrid&&a.hasOwnProperty("margin")&&c.isEmptyObject(a.margin)&&(a=this.fixMarginValue(a)),a):!1},fixMarginValue:function(a){if(this.formsMainCtrl.child.length){var b=this.getGeneralAttrs(),d=b.margin["default"].slice(),e=this.formsMainCtrl.child.prop("class").split(" ").filter(function(a){return b.margin.regExp.test(a)});e.length&&(c.each(e,function(a,e){var l=
e.match(b.margin.regExp),h=l[1],m=parseInt(l[2]);"undefined"===typeof h?c.each(d,function(a,c){m!==b.margin["default"][a]&&(d[a]=m)}):(l=c.inArray(h,b.margin.sides),-1!==l&&(d[l]=m))}),a.margin.value=d.join(","),this.setAttrs(a),a=this.getAttrs())}return a},setAttrs:function(a){this.shortcode.attr("data-motopress-styles",JSON.stringify(a))},setDefaultAttrs:function(a){a="undefined"===typeof a?this.getAttrs():c.parseJSON(a);var b=CE.LeftBar.myThis.getStyleAttrs(this.shortcodeGroup,this.shortcodeName);
c.each(a,function(a,e){if("undefined"===typeof e.value||!e.value){var f=b[a]["default"];switch(b[a].type){case "margin":var g=!0;c.each(b[a]["default"],function(c,e){e!==b[a].values[0]&&(g=!1)});f=g?"":f.join(",");break;case "select2":var l=[];b.mp_style_classes.hasOwnProperty("default")&&c.each(b.mp_style_classes["default"],function(a,b){l.push(b)});f=l.join(" ")}e.value=f}});this.setAttrs(a);return JSON.stringify(a)},display:function(a){CE.Dialog.myThis.styleTab.children(".motopress-style-forms").detach();
CE.Dialog.myThis.styleTab.html(this.form);var b=this.getAttrs();if(b){var d=this,e=null,f=null,g=null,l=null,h=this.getGeneralAttrs();c.each(b,function(c,k){f=d.getParameterElByName(c);e=f.control();g=b[e.name].value;l=h[e.name]["default"];e.set(g,l,a);f.trigger("customize")});this.resolveDependencies()}},save:function(a){var b=this.getAttrs();if(b)if("undefined"===typeof a&&this.formsMainCtrl.isGrid){var d=this;c.each(b,function(c){a=d.getCtrlByName(c);d._save(b,a,!1)})}else this._save(b,a),CE.Resizer.myThis.updateAllHandles(),
c(window).trigger("resize")},getTargetElement:function(a){var b=null;this.formsMainCtrl.isGrid?b=this.shortcode:this.formsMainCtrl.child.length&&(b=this.formsMainCtrl.child);"mp_style_classes"!==a.name&&"mp_custom_style"!==a.name||!CE.LeftBar.myThis.library[this.shortcodeGroup].objects[this.shortcodeName].styles[a.name].hasOwnProperty("selector")||(a=CE.LeftBar.myThis.library[this.shortcodeGroup].objects[this.shortcodeName].styles[a.name].selector,!1===a?b=null:a.length&&(b=b.find(a)));return b},
...
(d&&a.removeClass(e),a.addClass(f))}})}(jQuery),function(c){CE.ControlsForm("CE.StyleEditorControlsForm",{},{emptyStyleValue:"",editedStyleObj:null,loadedAttrs:{},styleEditorCtrl:null,propertiesWrapper:null,statesWrapper:null,actionsWrapper:null,state:null,beforeInit:function(){this._super();this.generateStatesWrapper();this.generatePropertiesWrapper();this.generateActionsWrapper()},init:function(a,b){this.styleEditorCtrl=b.styleEditorCtrl;this._super(a,b)},generateStatesWrapper:function(){var a=
this;this.statesWrapper=c("<div />",{"class":"motopress-ce-style-editor-states-wrapper"});this.statesWrapper.append(c("<a />",{href:"#","data-state":"up",title:localStorage.getItem("CEDesktopStyle")}),c("<a />",{href:"#","data-state":"tablet",title:localStorage.getItem("CETabletStyle")}),c("<a />",{href:"#","data-state":"mobile",title:localStorage.getItem("CEMobileStyle")}),c("<a />",{href:"#","data-state":"hover",title:localStorage.getItem("CEHoverStyle")}));this.statesWrapper.children("a").on("click",
function(b){b.preventDefault();a.setState(c(this).attr("data-state"))});this.element.append(this.statesWrapper)},generatePropertiesWrapper:function(){this.propertiesWrapper=c("<div />",{"class":"motopress-ce-style-editor-properties-wrapper"});this.element.append(this.propertiesWrapper)},generateActionsWrapper:function(){var a=this;this.actionsWrapper=c("<div />",{"class":"motopress-ce-style-editor-actions-wrapper"});var b=c("<button />",{"class":"motopress-ce-style-editor-apply-button btn",text:localStorage.getItem("CEApply")}).on("click",
function(b){b.preventDefault();a.confirm()}),d=c("<ul />",{"class":"dropdown-menu"});c.each(this.generateActionButtons(),function(a,b){var g=c("<li />");"undefined"!==typeof b.data("mpce-parent-classes")&&g.addClass(b.data("mpce-parent-classes"));g.append(b).appendTo(d)});b=c("<div />",{"class":"btn-group motopress-bootstrap-dropdown motopress-dropdown-button dropup"}).append(b,'<button class="dropdown-toggle btn" data-toggle="dropdown"><span class="caret"></span></button>',d);this.actionsWrapper.append(b);
this.element.append(this.actionsWrapper);b.on("keydown",function(a){a.stopPropagation()})},generateActionButtons:function(){var a=this;return[c("<a />",{href:"#","class":"motopress-ce-style-editor-cancel-button",text:localStorage.getItem("CECancel")}).on("click",function(b){b.preventDefault();a.cancel()})]},generate:function(){var a=this.getGeneralAttrs(),a=this.generatePropertiesControls(a,{});this.form.append(a)},detectForm:function(){this.form=this.propertiesWrapper},display:function(a){this.attachForm();
this.highlightState("up");this.rememberSettings();a=this.getStateAttrs("up");this.fillForm(a,"customize");this.resolveDependencies();this.show()},attachForm:function(){CE.Dialog.myThis.styleEditorContainer.children().detach();CE.Dialog.myThis.styleEditorContainer.html(this.element)},getState:function(){return this.state},setState:function(a){this.highlightState(a);this.fillForm(this.getStateAttrs(a),!1)},highlightState:function(a){this.statesWrapper.children("a").removeClass("motopress-ce-style-editor-state-active");
this.statesWrapper.children('[data-state="'+a+'"]').addClass("motopress-ce-style-editor-state-active");this.state=a;this.styleEditorCtrl.setStatePreview(a)},setEditedStyleObj:function(a){this.editedStyleObj=a},rememberSettings:function(){this.loadedAttrs=this.editedStyleObj.getSettings()},getFormValues:function(){var a,b,d={},e=this,f=this.getGeneralAttrs();c.each(f,function(c,f){a=e.getCtrlByName(c);a.isHided()||(b=a.get(),b=e.filterValue(c,b),b!==e.emptyStyleValue&&(d[c]=b))});d.hasOwnProperty("background-image-type")&&
"none"!==d["background-image-type"]&&(d.hasOwnProperty("background-gradient")||d.hasOwnProperty("background-image")||delete d["background-image-type"]);return d},getEmptyValues:function(){var a=this.getGeneralAttrs(),b=this;return c.map(a,function(){return b.emptyStyleValue})},getCleanFormValues:function(a){var b=this.getFormValues();a=this.getInheritValues(a);var d=parent.MP.Utils.getObjectChanges(a,b),e=this;c.each(d,function(a,c){e.preventLossDependencyValues(a,d,b)});return d},preventLossDependencyValues:function(a,
b,c){a=this.getCtrlByName(a);a.dependency&&a.dependency.hasOwnProperty("needDependenceValue")&&a.dependency.needDependenceValue&&!b.hasOwnProperty(a.dependency.parameter)&&(b[a.dependency.parameter]=c[a.dependency.parameter],this.preventLossDependencyValues(a.dependency.parameter,b,c))},filterValue:function(a,b){switch(a){case "padding-top":case "padding-bottom":case "padding-left":case "padding-right":case "border-top-width":case "border-bottom-width":case "border-left-width":case "border-right-width":case "border-top-left-radius":case "border-top-right-radius":case "border-bottom-left-radius":case "border-bottom-right-radius":b=
